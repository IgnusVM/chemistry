...
const VARIANT_CLASSES: Record<Variant, string> = {
  primary:
    "bg-fuchsia-600 text-onaccent shadow-sm shadow-fuchsia-600/20 hover:bg-fuchsia-700 hover:shadow-md hover:shadow-fuchsia-600/30 focus-visible:ring-fuchsia-400",
  secondary:
